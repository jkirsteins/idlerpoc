    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'The route repeats indefinitely until cancelled or funds run out for refueling. The mining panel shows route stats including trips completed, total revenue, and estimated profit per hour (accounting for [[crew-salaries|crew salaries]] and fuel costs).\n\nYou have several controls over an active mining route:\n- **Go sell now** — while mining, forces an immediate departure to the sell station (even if cargo is not full). The route continues normally after selling.\n- **Pause on next sell** — the ship completes the current sell trip, then stays docked at the sell station instead of returning to the mine. You can resume anytime.\n- **Abandon on next sell** — the ship sells ore on arrival, then the route ends permanently. You keep all earnings.\n\nThese options are available both from the mining panel at the mine location and as radio buttons during transit flights.',
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Traits provide small gameplay bonuses and penalties (typically 5-10%) to specific activities. A reckless crew member hits harder in [[encounters|combat]] but attracts more encounters. An ambitious crew member trains faster but demands higher [[crew-salaries|pay]]. A meticulous crew member excels at [[ship-equipment|repairs]] but is slightly weaker in combat. Effects marked with * are reserved for the future morale system.',
        ],
        table: {
          ...
          rows: [
            ...
            [
              'Reckless',
              '+10% combat attack',
              '+5% [[encounters|encounter]] rate',
            ],
            [
              'Cautious',
              '+5% [[encounters|evasion]]',
              '-5% [[mining-system|mining]] yield',
            ],
            ['Gregarious', '+10% negotiation', '—'],
            ['Meticulous', '+10% repair speed', '-5% combat attack'],
            ['Pragmatic', '+5% [[contracts|trade]] income', '—'],
            [
              'Idealistic',
              '+10% morale recovery*',
              '-10% departure resistance (leaves sooner when unpaid)',
            ],
            ['Sardonic', '+5% morale recovery*', '-5% negotiation'],
            [
              'Loyal',
              '+25% departure resistance (stays longer when unpaid)',
              '-5% trade income',
            ],

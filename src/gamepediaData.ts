...
export const GAMEPEDIA_ARTICLES: GamepediaArticle[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '[[provisions|Provisions]] (food and water) are auto-purchased when docked at trade stations. Crew eat station-side while docked, so ship provisions are only consumed during flight. Base consumption is 15 kg per crew per day, but [[life-support|life support]] recycling reduces this to ~5 kg effective.',
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    sections: [
      {
        paragraphs: [
          'Provisions represent the food, water, and basic consumables your crew needs to survive. Every ship carries provisions measured in kilograms, and every crew member consumes them while in flight or orbiting. While docked, crew eat station-side and ship provisions are not consumed. Running out of provisions during flight causes [[crew-death|starvation damage]] that can kill crew members.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          'When docked at a location with trade services, provisions are automatically purchased up to 30 days of supply for your current crew count. Since crew eat station-side while docked, your ship provisions remain at the level they were resupplied to until departure.',
      ...
      },
      {
        heading: 'Starvation',
        paragraphs: [
          'When provisions reach zero during flight, all crew take 3.0 health damage per day — aggressive damage that will kill unprotected crew within days. The captain is exempt from [[crew-death|death]] (health floors at 1) but still suffers damage effects. Starvation cannot occur while docked — crew eat station-side.',

...
Finite contracts (delivery, passenger, freight, supply) require player attention: they expire, refresh daily, and must be manually accepted and managed. This attention cost must be rewarded with meaningfully higher pay compared to infinite/automatable routes (trade routes, standing freight) that can be set and forgotten.
...
| -------------------------- | ------------------- | --------------------------------------------------------------------- |
| **High** (most rewarding)  | Passenger, Delivery | Short deadlines, one-shot — must watch for expiry and manually accept |
| **Medium**                 | Freight, Supply     | Multi-trip commitment with expiry — plan ahead, stay engaged          |
| **Low** (least rewarding)  | Standing Freight    | Automatable but regenerates randomly — may not always be available    |
...
| **Standing Freight** | 0.7x/trip      | **0.5x/trip**  | 0.65-1.0x costs       | Low: infinite, automatable, but randomly generated                          |
...
St.Freight(0.5x)  █████                 ← Passive: modest per-trip
...
- **3-day expiry** — tightest deadline of any quest
- **Quarters required** — not every ship can take passengers, creating opportunity cost
- **One-shot** — if you miss it, it's gone until tomorrow's refresh
...
- **30-day expiry** — longest deadline
...
### Standing Freight (0.5x per trip) — Modest Passive Income
...
- The "lazy" option — always profitable but thin margins reward active players who switch to better contracts when they appear
...
Per BACKLOG.md, standing freight could receive distance-based multiplier adjustments (0.5x short → 0.7x long). This would reward players who seek out longer standing freight routes while keeping short-haul standing freight firmly below active quest pay.
...
| Standing Freight/trip | 4,166 - 6,409 cr (0.7x) | 2,976 - 4,578 cr (0.5x)   | **-29%**  |
...
| Standing Freight/trip | 31,304 - 48,160 cr | 22,360 - 34,400 cr  | **-29%**  |
...
| Standing Freight/trip | 744k - 1,145k cr         | 532k - 818k cr           | **-29%**  |
...
4. **Don't add time pressure that feels punishing.** Expiry deadlines create urgency, not punishment. Expired quests refresh tomorrow. The player never loses money for missing a deadline — they just lose the opportunity to earn more.

...
- **Standing Freight Distance Multiplier**: Scale standing freight pay multiplier by route distance (0.6x short → 0.8x long). See `docs/quest-reward-balancing.md` and `docs/quest-economics-validation.md`.
